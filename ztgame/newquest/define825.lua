visit_npc_list110 = { {"千江镇的赵高", 461},{"鳄鱼潭的张仪", 469},{"凤祥镇西郊的王郎", 464} };
visit_npc_list1102 = { {"千江镇的来俊臣", 462},{"凤祥镇西郊的杜康", 467},{"鳄鱼潭的田文", 470} };

get_weapon_list110 = { {"105级月魔刀(白色)", 10311, 0}, {"105级月魔杖(白色)", 10511, 0}, {"105级月魔弓(白色)", 10561, 0},{"105级月魔扇(白色)", 10611, 0}, {"105级月魔棍(白色)", 10661, 0}}; 
get_weapon_list1102 = { {"105级月魔刀(蓝色)", 10311, 1}, {"105级月魔杖(蓝色)", 10511, 1}, {"105级月魔弓(蓝色)", 10561, 1}, {"105级月魔扇(蓝色)", 10611, 1}, {"105级月魔棍(蓝色)", 10661, 1}}; 

kill_npc_list110 = { {"倭寇营地的110级倭贼逃兵", 16583}, {"机械工厂六层的110级初级工匠", 10219},{"机械工厂六层的110级黄铜魔卫", 10221} };
kill_npc_list1102 = { {"机械工厂七层的115级特制石兵", 10229},{"机械工厂七层的115级特制铜兵", 10230},{"倭寇营地的115级倭贼流匪", 16589} }; 
...
function TaskDialog()
this:AddTalk("    这是一个环式任务，一旦接了就不能删除，完成任务后可以找接任务的NPC领取奖励，每次的奖励根据完成的任务数量和任务所在的环数决定。\n    如果任务中途离线超过1小时，那么当天任务自动结束！\n\n    这是本环第#qs#个任务\n    这是今天的第#round#环。\n\n经验奖励：#exp#");
...
function TaskDialog()
this:AddTalk("我需要5个#name#，全部找到后拿来给我。");
this:AddCloseItem("知道了")
end
...
function TaskDialog()
this:AddTalk("帮我杀#name#30只，然后回来告诉我。");
this:AddCloseItem("知道了")
end
...
function TaskDialog()
this:AddTalk("信总算送来了，你回去告诉环式任务使者(60)我知道了。");
...
function TaskDialog()
this:AddTalk("    你今天能完成的环数已经到上限，明天才能继续。");
