...
void CGuiManager::Render(float fElapsedTime)
{
	...
	//by=>friday, äÖÈ¾friday tooltip£¬¶ÀÁ¢ÏÔÊ¾ÔÚÖ÷tooltipÓÒ²à
	if(m_pToolTips_friday) 
	{
		//¸ù¾İÖ÷tooltipµÄÎ»ÖÃ¼ÆËãfriday tooltipÎ»ÖÃ
	...
	//by=>friday, äÖÈ¾friday1 tooltip£¬Ê¼ÖÕÏÔÊ¾ÔÚfriday tooltipÓÒ²à£¬²»×ö±ß½ç¼ì²â
